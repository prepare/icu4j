...
public final class ZoneMeta {
    ...
    */
     ...
     * If there is no mapping data, special short ID "unknown" will be returned.
     * @param tz the time zone
     * @return the short ID of the time zone, or null if the short ID is available.
     */
     ...
     * @return the short ID of the time zone ID, or null if the short ID is available.
     */
