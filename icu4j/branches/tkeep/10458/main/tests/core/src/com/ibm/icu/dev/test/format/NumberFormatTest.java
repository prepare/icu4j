...
public class NumberFormatTest extends com.ibm.icu.dev.test.TestFmwk {
    ...
    public void TestUnescape() {
        assertEquals("", "a\u00a0big bear", unescape("a\\u00a0big bear"));
    }
    
    public void testEscape() {
        assertEquals("", "a\\u00A0big bear", escape("a\u00a0big bear"));
    }
    ...
    private void showError(String message) {
        errln(String.format("line %d: %s", fileLineNumber, escape(message)));
        errln("    " + fileTestName);
        errln("    " + fileLine);
    }
    ...
    private String isPass(NumberFormatTestTuple tuple) {
        StringBuilder result = new StringBuilder();
        if (tuple.format.isSomething() && tuple.output.isSomething()) {
            String errorMessage = isFormatPass(tuple);
            if (errorMessage != null) {
