...
public class FieldsSet {
    ...
    public String fieldName(int field) {
        return (fEnum!=NO_ENUM)?DebugUtilities.enumString(fEnum, field):new Integer(field).toString();
    }
    
    public String toString() {
        String str = getClass().getName()+" ["+fFieldsCount+","+(fEnum!=NO_ENUM?DebugUtilities.typeString(fEnum):new Integer(fEnum).toString())+"]: ";
        for(int i=0;i<fFieldsCount;i++) {
            if(isSet(i)) {
