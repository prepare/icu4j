...
//#else
    ...
    /** 
     * Constant for date pattern denoted by the skeleton <code>MEEEd</code>.
     * @draft ICU 4.0
     * @provisional This API might change or be removed in a future release.
     */
    public static final String NUM_MONTH_WEEKDAY_DAY = "MEEEd";
    ...
    /** 
     * Constant for date pattern denoted by the skeleton <code>yMEEEd</code>.
     * @draft ICU 4.0
     * @provisional This API might change or be removed in a future release.
     */
    public static final String YEAR_NUM_MONTH_WEEKDAY_DAY = "yMEEEd";
      
    /** 
     * Constant for date pattern denoted by the skeleton <code>MMMEEEd</code>.
     * @draft ICU 4.0
     * @provisional This API might change or be removed in a future release.
     */
    public static final String ABBR_MONTH_WEEKDAY_DAY = "MMMEEEd";
    ...
    /** 
     * Constant for date pattern denoted by the skeleton <code>yMMMEEEd</code>.
     * @draft ICU 4.0
     * @provisional This API might change or be removed in a future release.
     */
    public static final String YEAR_ABBR_MONTH_WEEKDAY_DAY = "yMMMEEEd"; 
     ...
     * @provisional This API might change or be removed in a future release.
     */
    public static final String HOUR_MINUTE_GENERAL_TZ = "hmv";
     ...
     * @provisional This API might change or be removed in a future release.
     */
    public static final String HOUR_MINUTE_DAYLIGNT_TZ = "hmz";
     ...
     * @provisional This API might change or be removed in a future release.
     */
    public static final String HOUR_GENERAL_TZ = "hv";
     ...
     * @provisional This API might change or be removed in a future release.
     */
    public static final String HOUR_DAYLIGNT_TZ = "hz";
