...
public final class LocaleData {
    ...
    * @stable ICU 3.4
    */
    public static final int ES_CURRENCY = 2;

    /**
     * EXType for {@link #getExemplarSet(int, int)}.
     * @stable ICU 3.4
     */
    public static final int ES_AUXILIARY = 3;
    ...
    public UnicodeSet getExemplarSet(int options, int extype) {
        String [] exemplarSetTypes = { "ExemplarCharacters", "ExemplarCharactersIndex",
                "ExemplarCharactersCurrency", "AuxExemplarCharacters" };
        try{
