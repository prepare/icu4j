...
public class ExtensionsTest extends TestBase {
	...
	public static int main(String[] args) {
		...
		test.expert = ExpertFactory.getExpert(
				TypeHandlerFactory.COMMA_DELIMITED, test.env);
		test.doTest1("Comma #1", "ab,cd, AB, CD, EFG", "ab,cd, AB@, CD@, EFG");

		test.expert = ExpertFactory.getExpert(TypeHandlerFactory.EMAIL,
				test.env);
		...
		test.expert = ExpertFactory
				.getExpert(TypeHandlerFactory.FILE, test.env);
		test.doTest1("File #1", "c:\\A\\B\\FILE.EXT", "c:\\A@\\B@\\FILE@.EXT");

		test.expert = ExpertFactory.getStatefulExpert(TypeHandlerFactory.JAVA,
				test.env);
		...
		test.expert = ExpertFactory.getExpert(TypeHandlerFactory.PROPERTY,
				test.env);
		...
		test.expert = ExpertFactory.getStatefulExpert(
				TypeHandlerFactory.REGEXP, test.env);
		...
		test.env = test.envArabic;
		test.expert = ExpertFactory.getExpert(TypeHandlerFactory.REGEXP,
				test.env);
		...
		test.expert = ExpertFactory.getStatefulExpert(TypeHandlerFactory.SQL,
				test.env);
		...
		test.expert = ExpertFactory.getExpert(TypeHandlerFactory.SYSTEM_USER,
				test.env);
		test.doTest1("System #1", "HOST(JACK)", "HOST@(JACK)");

		test.expert = ExpertFactory.getExpert(TypeHandlerFactory.UNDERSCORE,
				test.env);
		test.doTest1("Underscore #1", "A_B_C_d_e_F_G", "A@_B@_C_d_e_F@_G");

		test.expert = ExpertFactory.getExpert(TypeHandlerFactory.URL, test.env);
		test.doTest1("URL #1", "WWW.DOMAIN.COM/DIR1/DIR2/dir3/DIR4",
				"WWW@.DOMAIN@.COM@/DIR1@/DIR2/dir3/DIR4");

		test.expert = ExpertFactory.getExpert(TypeHandlerFactory.XPATH,
				test.env);
