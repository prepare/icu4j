 ...
 * @deprecated afterInitialImport in favor of BidiStructuredProcessor as the public API
 */
public final class Processor {
    ...
    public static String process(String str, String separators) {
        ...
        Environment env = new Environment(null, false,
                BidiStructuredProcessor.Orientation.UNKNOWN);
     ...
     * @see #deprocessTyped
     */
    public static String processTyped(String str, BidiStructuredProcessor.StructuredTypes textType) {
        if ((str == null) || (str.length() <= 1))
            return str;
     ...
     */
    public static String deprocessTyped(String str, BidiStructuredProcessor.StructuredTypes textType) {
        if ((str == null) || (str.length() <= 1))
            return str;
