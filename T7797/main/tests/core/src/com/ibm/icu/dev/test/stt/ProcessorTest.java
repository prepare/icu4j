...
public class ProcessorTest extends TestBase {
	...
	private void doTest3(String msg, String data, String result, String resLean) {
		String full = Processor.processTyped(toUT16(data),
				TypeHandlerFactory.COMMA_DELIMITED);
		cntError += assertEquals(msg + "full", result, toPseudo(full));
	...
	public static int main(String[] args) {
		...
		// Test insertMarks()
		test.doTest4("Util #4.1 - ", "ABCDEFG", new int[] { 3, 6 }, 0, 0,
				"ABC@DEF@G");
		test.doTest4("Util #4.2 - ", "ABCDEFG", new int[] { 3, 6 }, 0, 2,
				">@ABC@DEF@G@^");
		test.doTest4("Util #4.3 - ", "ABCDEFG", new int[] { 3, 6 }, 1, 0,
				"ABC&DEF&G");
		test.doTest4("Util #4.4 - ", "ABCDEFG", new int[] { 3, 6 }, 1, 2,
				"<&ABC&DEF&G&^");
		test.doTest4("Util #4.5 - ", "", new int[] { 3, 6 }, 0, 0, "");
		test.doTest4("Util #4.6 - ", "", new int[] { 3, 6 }, 0, 2, "");
		test.doTest4("Util #4.7 - ", "ABCDEFG", null, 1, 0, "ABCDEFG");
		test.doTest4("Util #4.8 - ", "ABCDEFG", null, 1, 2, "<&ABCDEFG&^");
