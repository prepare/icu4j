...
public class KoreanTest extends CalendarTest {

    public static void main(String args[]) throws Exception {
        new KoreanTest().run(args);
    }
    ...
    public void TestMapping() {
        ...
        ChineseCalendar cal = new ChineseCalendar(ULocale.KOREA);
        StringBuffer buf = new StringBuffer();

        logln("Gregorian -> Korean Lunar");
    ...
    public void TestLimits() {
        ...
        ChineseCalendar lunar = new ChineseCalendar(ULocale.KOREA);
        doLimitsTest(lunar, null, tempcal.getTime());
        doTheoreticalLimitsTest(lunar, true);
    }
    ...
    public void TestCoverage() {
        // Coverage for constructors with KOREA locale
        {
            // new ChineseCalendar(Locale)
            ULocale.setDefault(ULocale.CHINA);
            ChineseCalendar cal = new ChineseCalendar(Locale.KOREA);
            if(cal == null){
                errln("could not create ChineseCalendar with Korea Locale");
            }
        }

        {
            ...
            ChineseCalendar cal = new ChineseCalendar(ULocale.KOREA);
            if(cal == null){
                errln("could not create KoreanLunarCalendar with ULocale");
            }
        }
    }
    ...
    public void TestInitWithCurrentTime() {
        ...
        ChineseCalendar cc = new ChineseCalendar(ULocale.KOREA);
